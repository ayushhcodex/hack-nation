...
class Settings:
    ...
    mlflow_experiment_name: str = os.getenv(
        "MLFLOW_EXPERIMENT_NAME", "agentic_healthbricks_india"
    )
    api_host: str = os.getenv("API_HOST", "0.0.0.0")
    api_port: int = int(os.getenv("API_PORT", "8000"))
    
    use_vector_search: bool = os.getenv("USE_VECTOR_SEARCH", "false").lower() == "true"
    vector_search_endpoint: str = os.getenv("VECTOR_SEARCH_ENDPOINT", "healthbricks_endpoint")
    vector_search_index: str = os.getenv("VECTOR_SEARCH_INDEX", "workspace.default.healthbricks_deserts")
    ...
    uc_volume_path: str = os.getenv("UC_VOLUME_PATH", "/Volumes/main/default/healthbricks")
