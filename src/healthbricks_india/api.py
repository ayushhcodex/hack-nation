...
from healthbricks_india.schemas import QueryRequest
...
app = FastAPI(title="HealthBricks India — Agentic Healthcare Intelligence", version="1.0.0")
...
@app.get("/api/health")
def health() -> dict:
    return {"status": "ok", "service": "HealthBricks India"}
